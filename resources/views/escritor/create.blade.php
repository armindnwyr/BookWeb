...
@section('content_header')
    <h1 class="text-center">Registrar Escritor</h1>
@stop
...
@section('content')
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              <form action="{{route('escritor.store')}}" method="post">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" rows="5" name="bibliografia" value="">{{ old('bibliografia') }}</textarea>
                        @error('bibliografia')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
