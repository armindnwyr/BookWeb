...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">Bookweb<span class="dot">.</span></a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="intro">
                        ...
                        <p class="mx-auto">En la biblioteca especializada de la EPIS. Contamos con nuevos libros en cada momento. Te invitamos a conocer nuestros ultimos ingresos.</p>
                    </div>
                </div>
            </div>
